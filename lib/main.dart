...
class _MyHomePageState extends State<MyHomePage> {
  ...
  UserLoginModel? userLogiModel;
  bool is_loader = false;
  Future<void> getLogin() async {
    is_loader = true;
    setState(() {});
    final getprefs = await SharedPreferences.getInstance();
    final userName = getprefs.getString('userName') ?? "NA";
    final password = getprefs.getString('password') ?? "NA";
    print("Counter: $userName");
    if (userName.isNotEmpty) {
      userLogiModel = await UserRepo()
          .loginRepo(userName: userName, context: context, password: password);
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                userLogiModel = await UserRepo().loginRepo(
                                  context: context,
                            ...
                            child: RichText(
                              text: const TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text:
                                        'Click Here', // Second part of the text
                                    style: TextStyle(
                                        color: Colors.indigo,
